            ...
            <div class="d-flex">
                <v-dialog v-model="visualAnaDialog" width="500">
                    ...
                    <v-card>
                        ...
                        <v-card-actions>
                            <v-spacer></v-spacer>
                            <v-btn color="primary" @click="visualAnaDialog = false">取消</v-btn>
                ...
                <template #item.actions="{ item }">
                    <div class="d-flex editBtns">
                        ...
                        <v-btn
                            ...
                            dark
                        >模型查看</v-btn>
                        <v-btn color="teal darken-1" dark>模型发布</v-btn>
    ...
    data() {
        return {
            ...
            modelHeaders: [
                ...
                { text: "创建时间", value: "graph_param.graph_message" },
                { text: "最后修改时间", value: "time_str" },
